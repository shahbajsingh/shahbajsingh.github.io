...
const Data = () => {
    ...
    return (
        <div className="home__data">
            <h1 className="home__title">shahbaj
                {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Freelance Developer</h3>
            <p className="home__description">I'm a freelance developer based in northern
                New Jersey, dedicated to learning new technologies to deliver innovative,
                cutting-edge software solutions to my clients.
            </p>

            <a href="#contact" className="button button--flex" 
            style={{ color: '#ffffff', backgroundColor: hover ? '#555555' : '#313639', /* NEW */
